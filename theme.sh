...
theme() {
  ...
  # ── Cambio de tema ─────────────────────────────────────
  dark | light | ocean | sky | mocha | latte | forest | meadow | hati | skoll | pokedark | pokelight | charizard | charizard_shiny | mega_charizard_x | mega_charizard_y)
  ...
  list)
    ...
    echo ""
    echo "  ── Par 6: pokedark / pokelight (Pokemon)"
    echo "  $([ "$current" = pokedark ] && echo "▶" || echo " ") pokedark        Pokemon Dark — Colores de marca dark"
    echo "  $([ "$current" = pokelight ] && echo "▶" || echo " ") pokelight       Pokemon Light  — Colores de marca light"
    echo ""
    echo ""
    echo "  ── Par 7: charizard / charizard_shiny (Pokemon)"
    echo "  $([ "$current" = charizard ] && echo "▶" || echo " ") charizard        Charizard normal"
    echo "  $([ "$current" = charizard_shiny ] && echo "▶" || echo " ") charizard_shiny       Charizard Shiny"
    echo ""
    echo "  ── Par 8: charizard x / charizard y (Megas)"
    echo "  $([ "$current" = mega_charizard_x ] && echo "▶" || echo " ") mega_charizard_x       Mega Charizard X"
    echo "  $([ "$current" = mega_charizard_y ] && echo "▶" || echo " ") mega_charizard_y       Mega Charizard Y"
    echo ""
    echo "  ▶ = tema activo"
    echo ""
    ;;
...
alias tpokedark="theme pokedark"
alias tpokelight="theme pokelight"
alias tcharizard="theme charizard"
alias tshiny="theme charizard_shiny"
alias tmega_x="theme mega_charizard_x"
alias tmega_y="theme mega_charizard_y"
